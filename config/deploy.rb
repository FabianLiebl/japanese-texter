...
set :deploy_to,   "/www/htdocs/w01a4a20/japanese-texter.de"
set :linked_files, fetch(:linked_files, []).push('.env.local')
set :linked_dirs, fetch(:linked_dirs, []).push('var/media').push('var/sessions').push('var/backups').push('var/backups-tmp')
