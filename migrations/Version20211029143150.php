 ...
 */
final class Version20211029143150 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_user (id INT AUTO_INCREMENT NOT NULL, firstName VARCHAR(255) DEFAULT NULL, lastName VARCHAR(255) DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, username VARCHAR(180) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) DEFAULT NULL, salt VARCHAR(255) DEFAULT NULL, confirmationToken VARCHAR(255) DEFAULT NULL, passwordRequestedAt DATETIME DEFAULT NULL, lastLogin DATETIME DEFAULT NULL, roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_F7129A80E7927C74 (email), UNIQUE INDEX UNIQ_F7129A80F85E0677 (username), UNIQUE INDEX UNIQ_F7129A801424F762 (confirmationToken), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_group (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE navigation_content (id INT AUTO_INCREMENT NOT NULL, node_id INT DEFAULT NULL, contentId INT DEFAULT NULL, contentClass VARCHAR(255) DEFAULT NULL, INDEX IDX_B8473EDA460D9FD7 (node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE navigation_link (id INT AUTO_INCREMENT NOT NULL, node_id INT DEFAULT NULL, link VARCHAR(1023) DEFAULT NULL, target VARCHAR(255) DEFAULT NULL, INDEX IDX_12C4C83460D9FD7 (node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media_format (id INT AUTO_INCREMENT NOT NULL, file_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, mimeType VARCHAR(255) DEFAULT NULL, extension VARCHAR(255) DEFAULT NULL, parameters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\', lockAt DATETIME DEFAULT NULL, INDEX IDX_62C3E80193CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE backup_backup_file (id INT AUTO_INCREMENT NOT NULL, backup_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_1BCB4C0A93BD6749 (backup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE backup_backup (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, backup VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE app_letter (id INT AUTO_INCREMENT NOT NULL, letter VARCHAR(255) DEFAULT NULL, sound VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE letter_tag (letter_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_BA157F124525FF26 (letter_id), INDEX IDX_BA157F12BAD26311 (tag_id), PRIMARY KEY(letter_id, tag_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE app_tag (id INT AUTO_INCREMENT NOT NULL, icon_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_2DFB044454B9D732 (icon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE backup_backup_file ADD CONSTRAINT FK_1BCB4C0A93BD6749 FOREIGN KEY (backup_id) REFERENCES backup_backup (id)');
        $this->addSql('ALTER TABLE letter_tag ADD CONSTRAINT FK_BA157F124525FF26 FOREIGN KEY (letter_id) REFERENCES app_letter (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE letter_tag ADD CONSTRAINT FK_BA157F12BAD26311 FOREIGN KEY (tag_id) REFERENCES app_tag (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE app_tag ADD CONSTRAINT FK_2DFB044454B9D732 FOREIGN KEY (icon_id) REFERENCES media_file (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_tag DROP FOREIGN KEY FK_2DFB044454B9D732');
        ...
        $this->addSql('ALTER TABLE backup_backup_file DROP FOREIGN KEY FK_1BCB4C0A93BD6749');
        $this->addSql('ALTER TABLE letter_tag DROP FOREIGN KEY FK_BA157F124525FF26');
        $this->addSql('ALTER TABLE letter_tag DROP FOREIGN KEY FK_BA157F12BAD26311');
        ...
        $this->addSql('DROP TABLE backup_backup_file');
        $this->addSql('DROP TABLE backup_backup');
        $this->addSql('DROP TABLE app_letter');
        $this->addSql('DROP TABLE letter_tag');
        $this->addSql('DROP TABLE app_tag');
